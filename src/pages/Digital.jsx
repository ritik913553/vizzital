...
const Digital = () => {
    useEffect(() => {
        document.title = "Vizztal | Digital";
    }, []);
    const recipeData = [
        {
    ...
    return (
        <div className="font-sans w-full min-h-screen   ">
            {/* Hero Section */}
            <section className="relative py-16 w-full p-6 lg:p-22 text-white">
                ...
                <div className="max-w-screen-2xl mx-auto 2xl:px-22 ">
                    ...
                    <p className="text-xl md:text-2xl max-w-3xl  mt-10  overflow-hidden">
                        ...
                        >
                            ...
                            capability to understand the potential of the
                            digital medium and align your marketing strategy
                            will define the success of your business.
                        </motion.span>
                    </p>
                    <p className="text-xl md:text-2xl max-w-3xl  mt-10  overflow-hidden">
                        <motion.span
                        ...
                        >
                            ...
                            platforms. We closely understand your objectives,
                            your audiences, their behaviour and your budgets.
                            Doing so, we devise and implement both in-bound and
                            out-bound marketing strategies that ensure success
                            through lead generation and content marketing.
                        </motion.span>
                    </p>
                </div>
            </section>
            ...
            <section className=" pt-20 bg-black text-white">
                {" "}
                <div className="grid md:grid-cols-2 max-w-screen-2xl mx-auto   border divide-x divide-y border-gray-300">
                    {serviceData.map((service, index) => (
                        <div
                            key={index}
                            className="p-2 xl:px-22 flex flex-col border-gray-300 md:divide-x md:flex-row"
                        >
            ...
            {/* Stats Section */}
            <section className="py-16 p-6 bg-gradient-to-b lg:px-22 from-[#0D3B76] to-[#080807] text-white ">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center max-w-screen-2xl mx-auto 2xl:px-22">
                    <div>
